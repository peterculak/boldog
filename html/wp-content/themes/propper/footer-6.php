...
$footer_map_show = propper_return_theme_option( 'footer_map_show');
...
?>
	 ...
	 <footer id="page-footer" class="block">
        <div class="container">
           <a href="<?php echo esc_url(home_url('/'));?>" class="brand"><img src="<?php echo esc_url($footer_logo_dark);?>" alt=""></a>
            <div class="contact map" id="contact">
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        
                        <?php if($footer_map_show == 'show'){ ?>
